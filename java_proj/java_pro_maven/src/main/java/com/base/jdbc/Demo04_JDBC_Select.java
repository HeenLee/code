 ...
 */
public class Demo04_JDBC_Select {
    public static void main(String[] args) {
        List<Demo03Emp> list = new Demo04_JDBC_Select().finaAll();
...
//            Class.forName("com.mysql.cj.jdbc.Driver");
            //2.获取连接
//            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/student?serverTimezone=UTC", "root", "root");
