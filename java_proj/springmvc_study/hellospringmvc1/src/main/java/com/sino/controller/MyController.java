 ...
 * 位置：类的上面
 * 和spring中讲的@Service，@Componemt都是创建对象的
 *
...
public class MyController {
     ...
     *              一个请求指定一个方法处理。
     *      属性：1.value ：是string，表示请求的URI地址的（some.do）
     *                     value的值必须是唯一的，不能重复。使用时，推荐地址以“/"开始
     *       位置：1.在方法的上面，常用的。
     *             2.在类的上面
     *        说明：使用RequestMapping修饰的方法叫作处理器方法或者控制器方法
    ...
    public ModelAndView doSome(){   //doGet() --调用service处理请求
        ...
        //相当于 request.setAttribute("msg","欢迎使用springmvc做web开发")
